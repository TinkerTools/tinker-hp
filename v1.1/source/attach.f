...
c
      if (associated(i13)) deallocate(i13)
      if (associated(n13)) deallocate(n13)
      if (associated(i14)) deallocate(i14)
      if (associated(n14)) deallocate(n14)
      if (associated(i15)) deallocate(i15)
      if (associated(n15)) deallocate(n15)
c
c    i13
c
