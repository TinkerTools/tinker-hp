...
<B>-Update 09/2022: support for neural networks potentials (ANI-2X, DeepMD etc...) is available in beta version (check Deep-HP branch). Check the Deep-HP module paper: https://arxiv.org/abs/2207.14276</B>
