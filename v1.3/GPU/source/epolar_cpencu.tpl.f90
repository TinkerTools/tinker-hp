...
!
!     "epolar_cpencu" : CUDA Template for calculation of the real space portion of the Ewald
!     summation energy and gradient due to dipole polarization
!     via a block-atom list with charge penetration
...
if (idec.eq.1) then
!
!     Loop over pairwise scaled interactions
!
...
!
!     Compute pairwise without scaling correction using nblist (C2)
!
