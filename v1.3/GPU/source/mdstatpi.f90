...
!     #################################################################
!     ##                                                             ##
!     ##  subroutine mdstatpi  --  compute averages over a pimd      ##
!     ##                                           trajectory        ##
!     #################################################################
!
!
!     "mdstatpi" is called at each molecular dynamics time step to
...
!              eint_ave = eintpi_sum / dble(iprint)
!              eint2_ave = eint2_sum / dble(iprint)
!              intfluct2 = eint2_ave - eint_ave**2
!              if (intfluct2 .gt. 0.0_d_prec) then
...
!       compute the average volume and its fluctuation
!
      if (display) then
...
!       compute the average piston temperature and its fluctuation
!
