...
!     #######################################################
!     ##                                                   ##
!     ##  module subMemory  --  Application Memory manager ##
!     ##                                                   ##
!     #######################################################
!
!     tinMemory submodule contains the implementation part of
!     of tinMemory
!
...
!    &    + 10*npoleloc*szoTp
!    &    + 18*npoleloc*szoTp + 12*npolebloc*szoTp
!    &    + 6*npolerecloc*szoTp
!    &    + 3*npoleloc*szoTp
!     wep = 3*npoleloc*szoTp
!    &    + max (12*npolelocnl*szoTp, 40*npolerecloc*szoTp
!    &      + 4*n1mpimax*n2mpimax*n3mpimax*nrec_recep*szoTp)
!     end if
...
!       if(size(array).eq.0) print*,'trouble prmem_int_req2',nl,nc,rank
end subroutine
