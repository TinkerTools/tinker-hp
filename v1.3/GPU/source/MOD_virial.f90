...
!     g_vx*  scalar component of virial
!     virsave stored internal virial Cartesian tensor components
!     g_svx*  scalar component of stored virial Cartesian
!     use_virial  switch on virial computing
!
!
