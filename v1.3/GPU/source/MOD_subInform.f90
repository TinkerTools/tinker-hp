...
submodule(inform) subInform
   ...
   use uprior ,only: polpred,maxualt
...
13    format(A20,2I10)
14    format(A20,F15.6)
15    format(A20,3X,A16)
16    format(A20,5x,L4)
17    format(A20,G15.4E1)
18    format(A20,A15,A6,I3)

      print 13, 'natoms', n
      print 15, 'integrator', integrate
      ...
      if (use_repuls) then
         print 15, 'repulsion cutoff'   , repcut
         print 15, 'repulsion short cutoff'   , repshortcut
         print 15, 'repulsion taper'    , reptaper
         print 15, 'shortheal'    , shortheal
      end if
      if (use_mpole.or.use_polar) then
         ...
         print 18, 'polar guess'  , polpred, ' -dim', maxualt
...
!
!     Print information on position, velocities and aceleration
!
...
!$acc end data
      ...
      if (rank.eq.0) then
30       format(A10,6F18.8)
32       format(A10,3F18.4)
         print 20
         print 30,"in p",minmax(01),minmax(06),minmax(02),minmax(07)  &
                 ,minmax(03),minmax(08)
         print 32,"in v",minmax(04),minmax(09),minmax(11)
         !if (opt_.eq.0) then
