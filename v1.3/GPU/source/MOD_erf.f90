...
!     #################################################################
!     ##                                                             ##
!     ##  module erf  --  data need to cumpute erf and erfc function ##
!     ##                                                             ##
!     #################################################################
!
...
!
!
!     "erf_acc" computes a numerical approximation to the value of
!     the error function via a Chebyshev approximation on a gpu
!
!
...
!
!
!     "erfc_acc" computes a numerical approximation to the value of the
!     complementary error function via a Chebyshev approximation a gpu
!
!
...
!     ########################################################################
!     ##                                                                    ##
!     ##  subroutine vderfc_acc  --  evaluate complementary error function  ##
!     ##                                                                    ##
!     ########################################################################
!
!
!     "vderfc_acc" computes a numerical approximation to the value of the
!     complementary error function via a Chebyshev approximation a gpu
!
!
...
!     #####################################################################
!     ##                                                                 ##
!     ##  subroutine erfcore_acc  --  erf and erfc via Chebyshev approx  ##
!     ##                                                                 ##
!     #####################################################################
!
!
!     "erfcore_acc" evaluates erf(x) or erfc(x) for a real argument x;
