...
M_subroutine image_orth_inl(xr,yr,zr)
!$acc routine seq
...
M_subroutine image_inl(xr,yr,zr)
!$acc routine seq
use tinheader,only:ti_p,prec_eps
#ifdef TINKER_CUF
use utilcu
...
M_subroutine image1_inl(xr,yr,zr,info)
!$acc routine seq
use tinheader,only:ti_p,prec_eps
#ifdef TINKER_CUF
use utilcu
