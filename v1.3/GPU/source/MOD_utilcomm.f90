...
!     ######################################################
!     ##                                                  ##
!     ##  utils communication module  -- Tinker-HP        ##
!     ##                                                  ##
!     ######################################################
!
!
!
!     Arrays to be used with MPI to exchange data and tracks requests
!     Some of them serve mainly as a memory pool to minimise
!     reallocation

!
!     do_not_commpole  switch to decide whether or not we should
!                      communicate __poleglob__
!     no_commdir       switch to avoid commfield communications
!     skpPcomm         switch to avoid commdirdir communication routine
!
