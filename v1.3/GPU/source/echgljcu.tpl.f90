!
!      Template version of ~echg_lj1_kcu~ routine
!      Compute Fused Lennard-Jones and Point Charge interactions in the
!      same kernel
...
attributes(global)&
   ...
   &,vcut2,vscut,voff2,voff,rinv,sheal&
...
real(t_p),value,intent(in):: coff2,f,aewald,aewaldop,ebuffer&
   &,vcut2,vscut,rinv,sheal,voff2,voff
...
!
            call duo_lj_(rik2,rik,rik_i,rvi,epsi*vscale,vcut2,vscut&
...
!
!       Vdw Special 1-4 pairwise interactions
!       -------------------------------------
do ii = ithread,n_scale,blockDim%x*gridDim%x
   block
      integer   it,kt
...
!       compute the energy contribution for this interaction
!
      call duo_lj(rik2,xpos,ypos,zpos,rvi,epsi*vscale,vcut2,vscut&
         &,rinv,voff,sheal,ugrp,fgrp,mutik&
         &,sck,sct,scs,scalpha,galpha,ulamdyn&
         &,lambda,vlambda,glamb,lambdavt,lambdavt1&
         ...
         computeInteraction:block
            ...
            if (rik2<=voff2) then
               block
                  ...
                  eps2  = epsilon (kt,it)
#endif
                  call duo_lj_(rik2,rik,rik_i,rv2,eps2,vcut2,vscut&
                     &,rinv,voff,sheal,ugrp,fgrp,mutik&
                     &,sck,sct,scs,scalpha,galpha,ulamdyn&
                     &,lambda,vlambda,glamb,lambdavt,lambdavt1&
