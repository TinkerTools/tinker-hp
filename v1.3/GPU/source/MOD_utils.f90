...
!     #######################################################################
!     ##                                                                   ##
!     ##  utils module  -- Tinker-HP utilities funcitons and subroutines   ##
!     ##                                                                   ##
!     #######################################################################
!
!
!     rpole_ind_extract  indice to extract rpole
!     rpole_der_ext      indice to extract rpole derivative term
!
...
!     ####################################################################
!     ##                                                                ##
!     ##  subroutine imagevec2  --  compute the minimum image distance  ##
!     ##                                                                ##
!     ####################################################################
!
!
!     "imagevec" takes the components of pairwise distances between
!     two points in a periodic box and converts to the components
!     of the minimum image distances
!
...
!
!     Convert forward a series of number to base n
!
...
!
!     Decomposition of base-n number
!
...
!      quot_r = cnum/base
!      quot   = aint(quot_r)
!      n0     = nint((quot_r - aint(quot_r))*base)
!      quot_r = quot/base
!      quot   = aint(quot_r)
!      n1     = nint((quot_r - aint(quot_r))*base)
!      quot_r = quot/base
!      quot   = aint(quot_r)
!      n2     = nint((quot_r - aint(quot_r))*base)
!      quot_r = quot/base
!      quot   = aint(quot_r)
!      n3     = nint((quot_r - aint(quot_r))*base)
!      quot_r = quot/base
!      quot   = aint(quot_r)
!      n4     = nint((quot_r - aint(quot_r))*base)
!      quot_r = quot/base
!      quot   = aint(quot_r)
!
!      if (quot.ne.0)
