...
!     ####################################################################################
!     ##                                                                                ##
!     ##  module orthogonalize  --  gather routines and data for                        ##
!     ##                            matrix orthogonalization and projection operators   ##
!     ##                                                                                ##
!     ####################################################################################
!
!     krylovDim   holds the krylov subspace dimension
!     nEigenV     holds the number of EigenVector to be computed
!     EigenVec_l  computes the EigenVectors to Tmat ? yes : no
!     lz_WorkSpace   holds the workspace for lanzcos iterations
!     lz_SS[*][_]    holds the storage space for module subroutine -- (*)instances  (_)inc precision
!     lz_T[*]        holds tridiagonal matrix computed from lanzcos iterations (*)dipoles
!
