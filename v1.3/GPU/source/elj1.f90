...
subroutine elj1c
   ...
   real(t_p) :: rho,rhok,rvk,lambdavt
   real(t_p) :: derho,gsc,dgscrho,dgsclambda, dgscrholambda
   real(t_p) :: d2gscdlambda2
   real(t_p) :: drhodelambdav, part1, part2, part3
   real(t_p) :: temp1,temp2,temp3,temp4
   real(t_p) :: drdelambdav
   real(t_p) :: drdelambdavdx, drdelambdavdy, drdelambdavdz
   real(t_p) :: galpha,glamb1,evdw,devdwgsc,d2evdwdgsc2
