...
!     #######################################################
!     ##                                                   ##
!     ##  module tinMemory  --  Application Memory manager ##
!     ##                                                   ##
!     #######################################################
!
!     s_shmem   shared memory size
!     sd_shmem  device shared memory size
!     sd_ddmem  device duplicated memory size
!     s_prmem   private memory size
!     sd_prmem  device private memory size
!     s_driver  CUDA Driver memory size
!     s_sfWork  Scaling factor workspace size
!     s_tinWork Tinker-HP workSpace Estimation
