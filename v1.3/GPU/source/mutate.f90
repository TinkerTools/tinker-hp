...
!
!     zero number of hybrid atoms, hybrid atom list and mutated torsions
!
   nmut = 0
   do i = 1, n
      mut(i) = .false.
...
!
!     scale electrostatic and torsion parameter values based on lambda
!
...
!
!     altered original state of elec entities
!
...
!
!     altered a copy of elec entities
!
...
15       format('Forbidden value of belambda: ',F15.3)
   ...
   disp = rank_.eq.0.and.verbose.and.mod(step_c,iprint/100).eq.0
#else
   disp = rank_.eq.0.and.verbose
#endif
   if (disp) then
