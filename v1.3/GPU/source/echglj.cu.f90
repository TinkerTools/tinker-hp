...
!     ################################################################
!     ##                                                            ##
!     ##  subroutine elj1cu  --  Lennard-Jones energy & derivatives ##
!     ##                                                            ##
!     ################################################################
!
!
!     "ehal1" calculates the Lennard-Jones van der waals energy and
...
module eChgLjcu
   ...
   use utilcu   ,only: ndir,VDW_BLOCK_DIM,ALL_LANES,use_virial,skipvdw12
