...
attributes(global) &
   ...
   ,cut2,scut,off2,off,loff2,sheal,rinv&
   ,ugrp,grplist,wgrp&
   ! lambdaDyn
...
real(t_p),value,intent(in) :: cut2,scut,rinv,off2,off,loff2,sheal&
...
!
         call duo_lj(rik2,xpos,ypos,zpos,rvi,epsi*vscale,cut2,scut&
      ...
      do j = 0,warpsize-1
         ...
         if (do_pair) then; block
               ...
               if (ugrp)&
                  &call groups2_inl(fgrp,iglob,kglob,ngrp,grplist,wgrp)
#endif
               call duo_lj(rik2,xpos,ypos,zpos,rv2,eps2,cut2,scut&
                  &,rinv,off,sheal,ugrp,fgrp,mutik&
                  &,sck,sct,scs,scalpha,galpha,ulamdyn&
                  &,lambda,vlambda,glamb,lambdavt,lambdavt1&
