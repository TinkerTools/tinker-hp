...
!     ################################################################
!     ##                                                            ##
!     ##  subroutine ehal1cu  --  buffered 14-7 energy & derivatives##
!     ##                                                            ##
!     ################################################################
!
!
...
!
!     *_t pointer variable destined to be attached to their target
#ifdef _CUDA
#define TINKER_CUF
...
!       All available features for hal kernel
!#define __tfea__ (__use_mpi__+__use_softcore__+__radepsOpt__+__use_shortRange__+__use_longRange__+__use_groups__)
!#define __tver__ (__use_ene__+__use_grd__+__use_vir__+__use_act__)
