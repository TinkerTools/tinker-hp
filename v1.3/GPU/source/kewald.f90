...
!
   ...
   ngrid2 = 0
!c
!c     by default, try adapting the 2d grid to the 3d real space domain decomposition
!c
!      if (mod(nprocloc,nydd).eq.0) then
!        ngrid1 = nydd
!        ngrid2 = int(nprocloc/nydd)
!      end if
...
!
!        keyword to let the 2decomp library optimize the 2d processor grid for parallel fft
!
         ngrid1 = 0
         ngrid2 = 0
      end if
...
!
!     enforce use of max spline order in all PME-based computations
!
...
!
!
!     enforce use of max pme grid in all PME-based computations
!
...
!
!    get maximum size of the grid of the neighbors
!
      do iproc = 0, nrec-1
...
!     ###############################################################
!     ##                                                           ##
!     ##  subroutine bspline  --  determine B-spline coefficients  ##
!     ##                                                           ##
!     ###############################################################
!
!
