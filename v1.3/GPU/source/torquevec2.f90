...
!
!
!     "torque2vec" takes the torque values on multiple sites defined by
!     a local coordinate frame and converts to Cartesian forces on
!     the original site and sites specifying the local frame
!
!     npolelocnl and npolelocnlloop came from mpole module
!
!     INPUT  : ivec is indices of sites
!              trqvec are trqs of sites
!              devecx,devecy and devecz are deps coming from epolar
!              or empole
!
!     OUTPUT : dvvecx, dwvecx and duvecx, etc... are forces
!              devecx,devecy and devecz are deps sent back to epolar
!              or empole
...
!     ######################################################################
!     ##                                                                  ##
!     ##  subroutine torquevecrec -- convert single site torque to force  ##
!     ##                                                                  ##
!     ######################################################################
!
!
