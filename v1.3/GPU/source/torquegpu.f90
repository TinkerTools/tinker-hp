!     #####################################################################
!     ##                                                                 ##
!     ##  subroutine torquegpu  --  convert single site torque to force  ##
!     ##                                                                 ##
!     #####################################################################
!
!
!     "torque2gpu" takes the torque values on multiple sites defined by
!     a local coordinate frame and converts to Cartesian forces on
!     the original site and sites specifying the local frame on the device
!
!     npolelocnl and npolelocnlloop came from mpole module
!
!     Matching between polaxe and ipolaxe
!     O  ->  'None'
!     1  ->  '3-Fold'
!     2  ->  'Bisector'
!     4  ->  'Z-bisect'
...
#endif
!
!     This routine is different form the first one only by his output
!
