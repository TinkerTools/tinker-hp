...
MOD_qtb.o: MOD_atmtyp.o MOD_atoms.o MOD_bath.o MOD_domdec.o MOD_langevin.o\
           ...
           MOD_utilgpu.o MOD_mdstuf.o MOD_spectra.o MOD_beads.o
MOD_spectra.o: MOD_atmtyp.o MOD_atoms.o MOD_bath.o MOD_beads.o MOD_domdec.o MOD_langevin.o\
           MOD_math.o MOD_moldyn.o MOD_sizes.o MOD_usage.o MOD_units.o MOD_random.o\
           MOD_utilgpu.o MOD_mdstuf.o MOD_boxes.o MOD_charge.o MOD_mpole.o MOD_atmlst.o\
...
echargecu.o: MOD_utilcu.o MOD_utilgpu.o pair_charge.inc.f90 echargecu.tpl.f90
echgljcu.o: MOD_utilcu.o MOD_utilgpu.o MOD_vdw.o echgljcu.tpl.f90 pair_lj.inc.f90 pair_charge.inc.f90
echgtrncu.o: MOD_utilcu.o MOD_utilgpu.o echgtrncu.tpl.f90 pair_chgtrn.inc.f90
efld0_cpencu.o: MOD_utilcu.o MOD_utilgpu.o pair_efld_cp.inc.f90
eljcu.o: MOD_utilcu.o MOD_utilgpu.o pair_lj.inc.f90 eljcu.tpl.f90
eliaison1cu.o: MOD_utilcu.o MOD_utilgpu.o MOD_vdw.o
ehal1cu.o: MOD_utilcu.o MOD_utilgpu.o MOD_vdw.o ehalcu.tpl.f90 pair_ehal.inc.f90
nblistcu.o: MOD_utilcu.o MOD_utilgpu.o
tmatxb_pmecu.o: MOD_utilcu.o MOD_utilgpu.o pair_tmatxb.inc.f90
tmatxb_pme_cpen.cu.o: MOD_utilcu.o MOD_utilgpu.o pair_tmatxb.inc.f90
empole1cu.o: MOD_utilcu.o MOD_utilgpu.o empolecu.tpl.f90 pair_mpole1.inc.f90
empole_cpencu.o: MOD_utilcu.o MOD_utilgpu.o empole_cpencu.tpl.f90 pair_mpole1.inc.f90
epolar1cu.o: MOD_utilcu.o MOD_utilgpu.o pair_polar.inc.f90
epolar_cpencu.o: MOD_utilcu.o MOD_utilgpu.o pair_polar_cpen.inc.f90 epolar_cpencu.tpl.f90
...
active.o:
alterchg.o: image.inc.f90 MOD_atoms.o MOD_atmlst.o MOD_atmlst.o MOD_inform.o MOD_mplpot.o MOD_potent.o
alterchg.gpu.o: image.inc.f90 MOD_atoms.o MOD_atmlst.o MOD_atmlst.o MOD_inform.o MOD_mplpot.o MOD_potent.o MOD_utilcomm.o
analysis.o: MOD_vdw.o
angles.o: MOD_utilgpu.o
mlpot.o: MOD_mlpot.o MOD_atoms.o MOD_bath.o MOD_domdec.o
...
baoabrespa.o: MOD_mlpot.o MOD_utilgpu.o MOD_utilbaoab.o
baoabrespapi.o: MOD_utilbaoabpi.o
baoabrespa1.o: MOD_mlpot.o MOD_utilgpu.o MOD_utilbaoab.o
bbk.o:
...
control.o:
cspline.o:
cutoffs.o: MOD_mlpot.o MOD_neigh.o
dcflux.o:
dcflux.gpu.o: MOD_cflux.o
diis.o:
domdecstuff.o: MOD_mlpot.o
dcdio.o: MOD_dcdio.o MOD_boxes.o MOD_files.o MOD_inform.o  MOD_iounit.o\
...
eangang3.o:
eangle.o:
eangle1.o: ker_angle.inc.f90
eangle1gpu.o: ker_angle.inc.f90
eangle3.o:
eangle3gpu.o: ker_angle.inc.f90
eangtor.o: ker_angtor.inc.f90
eangtor1.o: ker_angtor.inc.f90
eangtor3.o: ker_angtor.inc.f90
ebond.o: ker_bond.inc.f90
ebond1.o:
ebond1gpu.o: ker_bond.inc.f90
ebond3.o:
ebond3gpu.o: ker_bond.inc.f90
eliaison1gpu.o:
...
efld0_directgpu.o: MOD_neigh.o MOD_utilgpu.o pair_efld.inc.f90
egeom.o:
egeom1.o:
...
energy.o: MOD_mlpot.o MOD_utilgpu.o
eopbend.o: ker_opbend.inc.f90
eopbend1gpu.o: ker_opbend.inc.f90
eopbend3gpu.o: ker_opbend.inc.f90
...
esmd1.o:
estrbnd.o: ker_strbnd.inc.f90
estrbnd1.o:
estrbnd1gpu.o: ker_strbnd.inc.f90
estrbnd3.o: ker_strbnd.inc.f90
estrtor.o:
estrtor1.o:
estrtor1gpu.o:
estrtor3.o:
etors.o: ker_tors.inc.f90
etors1.o:
etors1gpu.o: ker_tors.inc.f90
etors3.o: ker_tors.inc.f90
etortor.o:
etortor1.o:
etortor1gpu.o:
etortor3.o:
eurey.o: ker_urey.inc.f90
eurey1.o:
eurey1gpu.o: ker_urey.inc.f90
eurey3.o:
eurey3gpu.o: ker_urey.inc.f90
...
fft_mpi.o:
field.o:
final.o: MOD_mlpot.o MOD_neigh.o MOD_pme.o MOD_utilgpu.o MOD_vdw.o
freeunit.o:
geometry.o:
getkey.o:
getnumb.o:
...
getword.o:
getxyz.o:
gradient.o: MOD_mlpot.o MOD_utilgpu.o
image.o:
initatom.o:
...
mpistuff.o: MOD_neigh.o MOD_pme.o MOD_sizes.o MOD_utilcomm.o MOD_utilgpu.o MOD_moldyn.o\
			 MOD_colvars.o MOD_mdstuf.o
mpiUtils.gpu.o: MOD_domdec.o MOD_utilcomm.o
mutate.o: MOD_sizes.o
nblist.o: MOD_mlpot.o MOD_neigh.o MOD_pme.o MOD_utilgpu.o MOD_vdw.o
...
respa.o: MOD_mlpot.o MOD_utilgpu.o
respa1.o: MOD_mlpot.o MOD_utilgpu.o
...
scalders.o:
unitcell.o:
verlet.o: MOD_mlpot.o MOD_utilgpu.o
version.o:
