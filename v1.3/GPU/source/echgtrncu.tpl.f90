...
logical  ,intent(in),value:: ugrp,ulamdyn
integer(1),device,intent(in):: mut(*)
real(t_p),intent(in),value:: f,elambda,ctrnscut,loff2,off2,off,cut2,sheal&
...
do ii = ithread, n_ctscale, blockDim%x*gridDim%x
   block;
      ...
      call duo_chgtrn(d2,pos%x,pos%y,pos%z,chgi,chgk,alphai,alphak&
          ...
          ,ctrntyp,ugrp,ulamdyn,mutik,elambda,delambdae_,e,frc&
          ,ver+__use_sca__,fea)
      ...
      if (ulamdyn)&
         call atomic_add_m(l_buff(lot),delambdae_)
#endif
      ...
      do j = 0,warpsize-1
         ...
         if (do_pair.and.d2<=off2.and.accept_mid)&
            ...
            call duo_chgtrn(d2,pos%x,pos%y,pos%z,chgi,chgk,alphai&
               ...
               &,ctrntyp,ugrp,ulamdyn,mutik,elambda,delambdae_,e,frc,ver,fea)
#if __tver__ & __use_act__
...
#if __tfea__ & __use_lambdadyn__
      if (ulamdyn)&
         call atomic_add_m1(l_buff(lot),delambdae0)
#endif
#if __tver__ & __use_act__
