...
!     ###################################################################
!     ##                                                               ##
!     ##  subroutine echarge3cgpu  --  Ewald charge analysis via list  ##
!     ##                                                               ##
!     ###################################################################
!
!
!
!     "echarge3cgpu" calculates the charge-charge interaction energy
...
!     update the number of gangs required for gpu
!
   f    = electric / dielec
   mode = 'EWALD'
   call switch (mode)
...
!     ###################################################################
!     ##                                                               ##
!     ##  subroutine elambdacharge3cgpu  --  Ewald charge analysis via list  ##
!     ##                                                               ##
!     ###################################################################
!
!
...
!     "echarge3cgpu" calculates the charge-charge interaction energy
!     and partitions the energy among the atoms using a particle
!     mesh Ewald summation, when lambdadyn is activated
!
!
