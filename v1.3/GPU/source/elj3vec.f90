...
!     ################################################################
!     ##                                                            ##
!     ## subroutine elj3vec -- Lennard-Jones vdw energy & analysis  ##
!     ##                                                            ##
!     ################################################################
!
!
...
!     #############################################################
!     ##                                                         ##
!     ## subroutine elj3cvec -- Lennard-Jones analysis via list  ##
!     ##                                                         ##
!     #############################################################
!
!
!     "elj3cvec" calculates the Lennard-Jones van der Waals energy
...
!
!
!     fill vectors to compute interactions involving this atom
!
      nnvlst   = nvlst(ii)
...
!
!        vscalevec = setscale2(iglob,kglobvec1,nvloop16,'vscale')
