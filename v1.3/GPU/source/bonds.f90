...
!         call dev_sort(npoleloc   ,poleglob   ,rec_stream)
...
!     if (associated(bl)     .and.nbond.eq.size(bl) .and.
!    &    associated(bndlist).and.  8*n.eq.size(bndlist)) return
