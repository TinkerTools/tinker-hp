...
! This file contains common code shared by all FFT engines
  ...
  ! ***TODO: once FFT fully integrated on GPU
  ! consider removing variable public attribute
  ...
  integer, save, public :: format                 ! input X-pencil or Z-pencil
  
  ! The libary can only be initialised once
  logical, save, public :: initialised = .false. 

  ! Global size of the FFT
  integer, save, public :: nx_fft, ny_fft, nz_fft

  ! 2D processor grid
  integer, save, dimension(2), public :: dims

  ! Decomposition objects
  TYPE(DECOMP_INFO), target, save, public :: ph  ! physical space
  TYPE(DECOMP_INFO), target, save, public :: sp  ! spectral space

  ! Workspace to store the intermediate Y-pencil data
  ! *** TODO: investigate how to use only one workspace array
  complex(mytype), allocatable, dimension(:,:,:), public :: wk2_c2c, wk2_r2c
  complex(mytype), allocatable, dimension(:,:,:), public :: wk13
