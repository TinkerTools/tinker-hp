...
yCOM = 5.403
zCOM = 1.177
plot 'SMD_output.dat' u 2:(sqrt(($3-xCOM)**2+($4-yCOM)**2+($5-zCOM)**2)) w l ls 1 linewidth 5.0 title 'End-to-end distance', \
     f(x) w l ls 2 linewidth 5.0 title 'Dummy atom linear motion'
set output
