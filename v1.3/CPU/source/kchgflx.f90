...
!
!> @brief 
!> assigns bond stretch and angle bend charge flux
!> correction values and processes any new or changed values
!> for these parameters
!> @param no params
subroutine kchgflx
...
!
!     subroutine dealloc_shared_chgflx : deallocate shared memory pointers for chgflx
!     parameter arrays
!
!> @brief 
!> deallocate shared memory pointers for chgflx
!> parameter arrays
!> @param no params
...
!
!     subroutine alloc_shared_chgflx : allocate shared memory pointers for chgflx
!     parameter arrays
!
!> @brief 
!> allocate shared memory pointers for chgflx
!> parameter arrays
!> @param no params
