...
!     ###################################################################
!     ##                                                               ##
!     ##  subroutine epolar3_group  --  "group" polarization           ##
!     ##                                                               ##
!     ###################################################################
!
!
!     "epolar3_group" calculates the dipole polarization energy
!     using a subset of atoms in gaz phase
!
!
!> @brief 
!> calculates the dipole polarization energy
!> using a subset of atoms in gaz phase
!> @param no params
...
!     #################################################################
!     ##                                                             ##
!     ##  subroutine epreal3_group  --  group polarization energy    ##
!     ##                                                             ##
!     #################################################################
!
!
!     "epreal3_group" evaluates the
!     polarization energy due to dipole polarization
