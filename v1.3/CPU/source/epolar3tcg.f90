...
!     ###################################################################
!     ##                                                               ##
!     ##  subroutine epolar3tcg  --  induced dipole energy & analysis  ##
!     ##                                                               ##
!     ###################################################################
!
!
!     "epolar3tcg" calculates the induced dipole polarization energy with the tcg method,
!     and partitions the energy among atoms
!
!
!> @brief 
!> calculates the induced dipole polarization energy with the tcg method,
!> and partitions the energy among atoms
!> @param no params
...
!     #############################################################################
!     ##                                                                         ##
!     ##  subroutine epolar3tcg1  --  Ewald polarization analysis with tcg1      ##
!     ##                                                                         ##
!     #############################################################################
!
!
!     "epolar3tcg1" calculates the induced dipole polarization energy with the tcg1 method,
!     and partitions the energy among atoms
!
!> @brief 
!> calculates the induced dipole polarization energy with the tcg1 method,
!> and partitions the energy among atoms
!> @param no params
...
!
!     if omegafitstep then store intermediate values
!
...
!
   ...
   nep = nloc
!
!     move dipoles in global variables
!
   do i = 1, npolebloc
      iipole = poleglob(i)
      do j = 1,3
...
!     #############################################################################
!     ##                                                                         ##
!     ##  subroutine epolar3tcg2  --  Ewald polarization analysis with tcg2      ##
!     ##                                                                         ##
!     #############################################################################
!
!
!     "epolar3tcg2" calculates the induced dipole polarization energy with the tcg2 method,
!     and partitions the energy among atoms
!
!> @brief 
!> calculates the induced dipole polarization energy with the tcg2 method,
!> and partitions the energy among atoms
!> @param no params
