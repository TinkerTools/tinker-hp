...
!     ##################################################################
!     ##                                                              ##
!     ##  subroutine epitors3  --  pi-orbit torsion potential energy  ##
!     ##                                                              ##
!     ##################################################################
!
!
!     "epitors3" calculates the pi-orbital torsion potential energy;
...
!
!
!     zero out the pi-orbital torsion energy and partitioning terms
!
   nept = 0
   ept = 0.0d0
   aept = 0.0d0
