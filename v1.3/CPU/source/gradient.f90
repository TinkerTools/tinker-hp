...
!
!> @brief 
!> calls subroutines to calculate the potential energy
!> and first derivatives with respect to Cartesian coordinates
!> @param[in] energy: total potential energy value
!> @param[in] derivs: array of derivatives of the total potential energy
