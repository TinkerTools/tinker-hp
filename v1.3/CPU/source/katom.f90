...
!     8, 786-798 (1999)  [heavy hydrogen reweighting]
!
!> @brief 
!> assigns an atom type definitions to each atom in
!> the structure and processes any new or changed values
!> @param no params
subroutine katom
   use atmtyp
...
!
!     subroutine dealloc_shared_katom : deallocate shared memory pointers for katom
!     parameter arrays
!
!> @brief 
!> deallocate shared memory pointers for katom
!> parameter arrays
!> @param no params
...
!
!     subroutine alloc_shared_katom : allocate shared memory pointers for katom
!     parameter arrays
!
!> @brief 
!> allocate shared memory pointers for katom
!> parameter arrays
!> @param no params
