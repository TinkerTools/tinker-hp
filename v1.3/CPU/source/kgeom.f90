...
!
!> @brief 
!> assigns parameters for geometric restraint terms
!> to be included in the potential energy calculation
!> @param no params
subroutine kgeom
   use atmlst
...
!
!     restrain backbone atoms at their initial position (equilibration phase)
!
...
!
!
!     subroutine kgeom_update: update local geom
!
!> @brief 
!> computes and displays the total potential energy
!> update local geom parameters
!> @param no params
...
!
!     subroutine dealloc_shared_geom : deallocate shared memory pointers for geometric restraint
!     parameter arrays
!
!> @brief 
!> deallocate shared memory pointers for geometric restraint
!> parameter arrays
!> @param no params
...
!
!     subroutine alloc_shared_geom : allocate shared memory pointers for geometric restraint
!     parameter arrays
!
!> @brief 
!> allocate shared memory pointers for geometric restraint
!> parameter arrays
!> @param no params
