...
!
!     if vdwrange = 'long', calculates just the long range part
!     if vdwrange = 'short', calculates just the short range part
!
!> @brief 
!> calculates the Lennard Jones 12-6 van der Waals energy
!> and its first derivatives using a pairwise neighbor list
!> @param no params
subroutine elj1c
   use atmlst
   ...
   real*8 :: galpha,glamb1,evdw,devdwgsc,delambdavtemp
