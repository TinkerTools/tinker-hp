...
!
!> @brief 
!> assigns the force constants for out-of-plane bends
!> at trigonal centers via Wilson-Decius-Cross or Allinger angles;
!> also processes any new or changed parameter values
!> @param no params
subroutine kopbend
...
!
!     use special out-of-plane bend parameter assignment for MMFF
!
...
!
!     subroutine kopbend_update: update local opbend
!
!> @brief 
!> update local opbend parameters
!> @param no params
subroutine kopbend_update
   use angle
   use angpot
   use atmlst
   use atmtyp
...
!     ##################################################################
!     ##                                                              ##
!     ##  subroutine kopbendm  --  MMFF out-of-plane bend parameters  ##
!     ##                                                              ##
!     ##################################################################
!
!
...
!
!     assign MMFF out-of-plane bending parameter values
!
   nopbend = 0
   if (nopb .ne. 0) then
      do i = 1, nangle
...
!
!     subroutine kopbendm_update: update local opbendm
!
!> @brief 
!> update local opbendm parameters
!> @param no params
subroutine kopbendm_update
   use angle
   use atmtyp
   use atmlst
   use atoms
...
!
!     subroutine dealloc_shared_opbend : deallocate shared memory pointers for opbend
!     parameter arrays
!
!> @brief 
!> deallocate shared memory pointers for opbend
!> parameter arrays
!> @param no params
...
!
!     subroutine alloc_shared_opbend : allocate shared memory pointers for opbend
!     parameter arrays
!
!> @brief 
