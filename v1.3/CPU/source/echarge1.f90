...
!
!     echarge1c: charge electrostatic interactions
!
!> @brief 
...
!
!
!     "ecreal1d" evaluates the real space portion of the Ewald sum
!     energy and first derivative due to atomic charge interactions
...
!
   allocate (cscale(n))
!
!     initialize connected atom scaling
!
   cscale = 1.0d0
!
...
!
            ...
            e  =  e * facts
!
!              when two interacting atoms are mutated
!
            if (use_lambdadyn) then
               delambdaetemp = 0d0
...
!     #################################################################
!     ##                                                             ##
!     ##  subroutine ecrecip1  --  PME recip charge energy & derivs  ##
!     ##                                                             ##
!     #################################################################
!
!
