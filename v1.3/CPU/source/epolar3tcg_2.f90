...
!     #############################################################################
!     ##                                                                         ##
!     ##  subroutine epolar3tcg1_2  --  Ewald polarization analysis with tcg1    ##
!     ##                                                                         ##
!     #############################################################################
!
!
!     "epolar3tcg1_2" calculates the induced dipole polarization energy with the tcg1 method,
!     and partitions the energy among atoms, with separate cores for PME
!
!> @brief 
...
!     ###############################################################################
!     ##                                                                           ##
!     ##  subroutine epolar3tcg2_2  --  Ewald polarization analysis with tcg2      ##
!     ##                                                                           ##
!     ###############################################################################
!
!
!     "epolar3tcg2_2" calculates the induced dipole polarization energy with the tcg2 method,
!     and partitions the energy among atoms with separate cores for PME
!
!> @brief 
