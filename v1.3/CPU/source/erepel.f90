...
!     #################################################################
!     ##                                                             ##
!     ##  subroutine erepel  --  Pauli repulsion energy & analysis   ##
!     ##                                                             ##
!     #################################################################
!
!
...
!     ##################################################################
!     ##                                                              ##
!     ##  subroutine erepel0c  --  Pauli repulsion analysis via list  ##
!     ##                                                              ##
!     ##################################################################
!
!
!     "erepel3b" calculates the Pauli repulsion energy
!
!
!> @brief 
!> calculates the Pauli repulsion energy
...
!
   if (deb_Path) write(iout,*), 'erepel0c '
!
