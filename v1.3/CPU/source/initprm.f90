...
!
!> @brief 
!> completely initializes a force field by setting all
!> parameters to zero and using defaults for control values
!> @param no params
subroutine initprm
   use sizes
...
!
!     initialize values of some force field parameters
!
   forcefield = blank20
   do i = 1, maxtyp
      symbol(i) = blank3
...
!
!     initialize values of some MMFF-specific parameters
!
   do i = 1, 100
      do j = 1, 100
...
!
   ...
   dpequal = .false.
!
!     set default divide and conquer ji/diis parameters
!
   clsttype = 2
   precomp = 0
   nocomdiis = 0
