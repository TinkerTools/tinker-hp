...
!     ###################################################################
!     ##                                                               ##
!     ##  subroutine gradfast1  --  fast energy & gradient components  ##
!     ##                                                               ##
!     ###################################################################
!
!
...
!> for the fast-evolving local valence potential energy terms
!> @param[in] energy: contribution of fast potentials to the potential energy
!> @param[in] derivs: derivatives of contribution of fast potentials to the potential energy
...
!     ##########################################################################
!     ##                                                                      ##
!     ##  subroutine gradint1  --  intermediate energy & gradient components  ##
!     ##                                                                      ##
!     ##########################################################################
!
!
!     "gradfast" calculates the potential energy and first derivatives
!     for the intermediate- potential energy terms
!
!
!> @brief 
!> calculates the potential energy and first derivatives
!> for the intermediate- potential energy terms
!> @param[in] energy: contribution of intermediate potentials to the potential energy
!> @param[in] derivs: derivatives of contribution of intermediate potentials to the potential energy
...
!
!
!     also save the values of the short range real space forces
!
   desave = dep
   esave = ep
   return
...
!     ###################################################################
!     ##                                                               ##
!     ##  subroutine gradslow1  --  slow energy & gradient components  ##
!     ##                                                               ##
!     ###################################################################
!
!
...
!> calculates the potential energy and first derivatives
!> for the slow-evolving nonbonded potential energy terms
!> @param[in] energy: contribution of slow potentials to the potential energy
!> @param[in] derivs: derivatives of contribution of slow potentials to the potential energy
...
!> @brief 
!> find fast-evolving velocities and positions via velocity Verlet recursion
!> @param[in] ealt: local potential energy contribution
!> @param[in] viralt: local virial contribution
!> @param[in] dta: small timestep
