...
!
!> @brief 
!> assigns the force constants for out-of-plane
!> distance at trigonal centers via the central atom height;
!> also processes any new or changed parameter values
!> @param no params
subroutine kopdist
...
!
   ...
   zeros = '000000000000'
!
!     deallocate some global pointers if necessary
!
   call dealloc_shared_opdist
!
!     allocate some global pointers
!
...
!
!     subroutine kopdist_update: update local opdist
!
!> @brief 
!> update local opdist parameters
!> @param no params
subroutine kopdist_update
   use angpot
   use atmlst
   use atmtyp
   use atoms
...
!
!     subroutine dealloc_shared_opdist : deallocate shared memory pointers for opdist
!     parameter arrays
!
!> @brief 
!> deallocate shared memory pointers for opdist
!> parameter arrays
!> @param no params
...
!
!     subroutine alloc_shared_opdist : allocate shared memory pointers for opdist
!     parameter arrays
!
!> @brief 
!> allocate shared memory pointers for opdist
!> parameter arrays
!> @param no params
