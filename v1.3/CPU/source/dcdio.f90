...
!> @brief 
!> write frame on existing dcd file
!> @param[in] dcdinfo: info about dcd to write in
!> @param[in] istep: timestep
!> @param[in] suffix: suffix of the dcd file
...
!> open dcd file
!> @param[in] dcdinfo: info about dcd to write in
!> @param[in] dcdfile: name of the dcd file
...
!> @param[in] dcdinfo: info about dcd to write in
!> @param[in] dowrite: do we need to append frame
!> @param[in] verbose: verbosity of log
