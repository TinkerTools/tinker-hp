...
!     ##################################################################
!     ##                                                              ##
!     ##  subroutine edisp  --  damped dispersion energy              ##
!     ##                                                              ##
!     ##################################################################
!
!
!     "edisp" calculates the dispersion energy; also partitions
...
!     #################################################################
!     ##                                                             ##
!     ##  subroutine edisp0b  --  damp dispersion energy via list    ##
!     ##                                                             ##
!     #################################################################
!
!
...
!
!> @brief 
!> calculates the damped dispersion potential energy
!> using a pairwise neighbor list
!> @param no params
subroutine edisp0b
   use atmlst
...
!     ##################################################################
!     ##                                                              ##
!     ##  subroutine edisp0d  --  Ewald dispersion energy via loop    ##
!     ##                                                              ##
!     ##################################################################
!
!
...
!
!> @brief 
!> calculates the dispersion interaction energy using
!> particle mesh Ewald summation and a double loop
!> @param no params
subroutine edisp0d
   use analyz
...
!
!
!     zero out the damped dispersion energy
!
   edsp = 0.0d0
   if (ndisp .eq. 0)  return
!
...
!     #################################################################
!     ##                                                             ##
!     ##  subroutine edrecip  --  PME recip space damped dispersion  ##
!     ##                                                             ##
!     #################################################################
!
!
...
!
!     account for the total energy correction term
!
...
!     ##################################################################
!     ##                                                              ##
!     ##  subroutine edreal0d  --  real space disp energy via list    ##
!     ##                                                              ##
!     ##################################################################
!
!
!     "edreal0d" evaluated the real space portion of the damped
!     dispersion energy using Ewald and a neighbor list
!
!
!> @brief 
!> "edreal0d" evaluated the real space portion of the damped
...
!
!     increment the overall dispersoin energy components
!
               edsp = edsp + e
!
!     increment the total intermolecular energy
