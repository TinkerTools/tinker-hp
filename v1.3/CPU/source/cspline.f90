...
!
!> @brief 
!> computes the coefficients for a periodic interpolating
!> cubic spline
!> @param no params
...
!
!> @brief 
!> finds the Cholesky factors of a cyclically tridiagonal
!> symmetric, positive definite matrix given by two vectors
!> @param no params
...
!
!> @brief 
!> solves a cyclically tridiagonal linear system
!> given the Cholesky factors
!> @param no params
