...
!
!> @brief 
!> assigns partial charges to the atoms within
!> the structure and processes any new or changed values
!> @param no params
subroutine kcharge
   use atmlst
...
!
!     subroutine kcharge_update: update local charges
!
!> @brief 
...
!
!> @brief 
!> assigns partial charges to the atoms according to
!> the Merck Molecular Force Field (MMFF)
!> @param no params
subroutine kchargem
   use sizes
...
!
!> @brief 
!> deallocate shared memory pointers for chg
!> parameter arrays
!> @param no params
...
!
!> @brief 
!> allocate shared memory pointers for chg
!> parameter arrays
!> @param no params
