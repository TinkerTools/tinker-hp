...
Various pages documenting the capabilities of the package as well as guidelines to use it are given in the [Related Pages](pages.html) section, you will find:
  - [an overview of the suite detailing the programs and their cabapibilites](md_binaries_doxygen.html)
  - [prerequisites and a guide to compile the CPU version](md_Build_CPU.html)
  - [prerequisites for the GPU version](md_Prerequisites_doxygen.html) and a [guide to build it](md_Build_GPU.html)
  - [detailed information about the dynamic program to run molecular dynamics](md_dynamic_doxygen.html)
  - [a list of the potential energy functions available](md_potential_doxygen.html)
  - [information about I/O](md_io_doxygen.html)
  - [general information about free energy calculations](md_free_energy.html)
  - [detailed information about the Lambda-abf method for free energy simulation](md_lambda-abf_doxygen.html)
  - [a guide to use the Deep-HP interface to use Machine Learning Potentials](md_Deep-HP.html)
  - [a guide to use Quantum-HP to include Nuclear Quantum Effects in molecular dynamics](md_Quantum-HP_doxygen.html)
