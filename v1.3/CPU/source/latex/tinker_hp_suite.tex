...
\end{DoxyItemize}\hypertarget{tinker_hp_suite_running_the_programs}{}\section{Running the Programs}\label{tinker_hp_suite_running_the_programs}
...
The 5 programs are listed below with a description of the command line necessary to run them. In the case of an incomplete command line or a missing input file, an error message describing the missing point will be printed.\hypertarget{tinker_hp_suite_program_analyze}{}\section{analyze}\label{tinker_hp_suite_program_analyze}
...
\end{DoxyItemize}\hypertarget{tinker_hp_suite_program_dynamic}{}\section{dynamic}\label{tinker_hp_suite_program_dynamic}
...
\begin{quotation}
{\bfseries Note\-:} More information about the features available with the {\bfseries dynamic} program, such as integrators, thermostats and barostats, can be found here.

\end{quotation}
\hypertarget{tinker_hp_suite_program_minimize}{}\section{minimize}\label{tinker_hp_suite_program_minimize}
...
\begin{quotation}
{\bfseries Note\-:} More information about the features available with the {\bfseries minimize} program, such as minimization algorithms and minimized geometry output can be found here.

\end{quotation}
\hypertarget{tinker_hp_suite_program_pimd}{}\section{P\-I\-M\-D}\label{tinker_hp_suite_program_pimd}
...
\end{DoxyItemize}\hypertarget{tinker_hp_suite_program_bar}{}\section{bar}\label{tinker_hp_suite_program_bar}
...
\end{DoxyCode}
\hypertarget{tinker_hp_suite_program_testgrad}{}\section{testgrad}\label{tinker_hp_suite_program_testgrad}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{tinker_hp_suite_general_information}{}\section{General Information}\label{tinker_hp_suite_general_information}

\begin{DoxyItemize}
\item List of potential energy terms compatible with Tinker-\/\-H\-P Tinker-\/\-H\-P is compatible with numerous bonded and non-\/bonded potential energy terms. For each of them, energies and analyticals gradients can be computed by running the programs described above. Each of them is associated with a number of features that can be modified by some keywords to be added to the keyfile. A list of these potential energy terms with associated keywords can be found here.
\item Info about output of trajectories
\item Info about free energy simulations, with specifics about alchemical ones through Lambda-\/\-A\-B\-F and related methodologies 
\end{DoxyItemize}