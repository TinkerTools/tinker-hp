...
!
!> @brief 
!> assigns particle mesh Ewald parameters and options
!> for a periodic system
!> @param no params
subroutine kewald
   use atoms
...
!
!
!     initialization of PME related quantities, after (potential)
!     initialization of comm_rec communicator
!
!> @brief 
!> initialization of PME related quantities, after (potential)
!> initialization of comm_rec communicator
...
!
!     subroutine kewald_dd_init: initialization of ewald related dd quantities
!
!> @brief 
...
!
!> @brief 
!> finds an Ewald coefficient such that all terms
!> beyond the specified cutoff distance will have a value less
!> than a specified tolerance
!> @param[in] alpha: ewald coefficient to be found
...
!
!> @brief 
!> sets the moduli of the inverse discrete Fourier
!> transform of the B-splines
!> @param no params
subroutine moduli
   use pme
...
!
!> @brief 
!> calculates the coefficients for an n-th order
!> B-spline approximation
!> @param no params
...
!
!> @brief 
!> computes the modulus of the discrete Fourier transform
!> of "bsarray" and stores it in "bsmod"
!> @param[in] bsmod: modulus of DFT of bsarray
!> @param[in] bsarray: values from which the DFT of the modulus will be computed
!> @param[in] nfft: dimension of the DFT grid
!> @param[in] order: order of the B-spline
