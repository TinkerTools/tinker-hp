...
!     ###################################################################
!     ##                                                               ##
!     ##  subroutine epolar1tcg  --  induced dipole energy & gradient  ##
!     ##                                                               ##
!     ###################################################################
!
!
!     "epolar1tcg" calculates the induced dipole polarization energy and gradients with the tcg method
!
!
!> @brief 
...
!
!     recompute the optimal value for omega (TCG-PEEK) if needed
!
...
!     ########################################################################
!     ##                                                                    ##
!     ##  subroutine epolar1tcg1  --  Ewald polarization energy             ##
!     ##                               and grad with tcg1                   ##
!     ##                                                                    ##
!     ########################################################################
!
!
!     "epolar1tcg1" calculates the induced dipole polarization gradients with the tcg1 method
!
!> @brief 
