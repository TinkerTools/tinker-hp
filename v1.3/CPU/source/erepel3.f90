...
!     #################################################################
!     ##                                                             ##
!     ##  subroutine erepel3  --  Pauli repulsion energy & analysis  ##
!     ##                                                             ##
!     #################################################################
!
!
...
!
!> @brief 
!> calculates the Pauli repulsion energy and partitions
!> the energy among the atoms
!> @param no params
subroutine erepel3
   use inform
...
!     ##################################################################
!     ##                                                              ##
!     ##  subroutine erepel3c  --  Pauli repulsion analysis via list  ##
!     ##                                                              ##
!     ##################################################################
!
!
!     "erepel3c" calculates the Pauli repulsion energy and also
!     partitions the energy among the atoms using a neighbor list
!
!
!> @brief 
!> calculates the Pauli repulsion energy and also
!> partitions the energy among the atoms using a neighbor list
!> @param no params
subroutine erepel3c
   use action
...
!
!     zero out Pauli repulsion energy and partitioning terms
!
   ner = 0
   er = 0.0d0
   aer = 0.0d0
...
!
!     get interaction energy, via soft core lambda scaling as needed
!
               if (mutik) then
