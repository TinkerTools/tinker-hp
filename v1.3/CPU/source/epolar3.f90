...
!     ##################################################################
!     ##                                                              ##
!     ##  subroutine epolar3c  --  Ewald polarization analysis; list  ##
!     ##                                                              ##
!     ##################################################################
!
!
...
!
!> @brief 
!> calculates the polarization energy and analysis with
!> respect to Cartesian coordinates using particle mesh Ewald and
!> a neighbor list
!> @param no params
subroutine epolar3c
...
!     ###################################################################
!     ##                                                               ##
!     ##  subroutine epreal3d  --  real space polar analysis via list  ##
!     ##                                                               ##
!     ###################################################################
!
!
...
!
!
!     subroutine totaldipole: get the total dipole moment of the system (permanent+induced)
!
!> @brief 
