...
!     ###################################################################
!     ##                                                               ##
!     ##  subroutine epolar1_group  --  "group" polarization           ##
!     ##                                                               ##
!     ###################################################################
!
!
!     "epolar1_group" calculates the dipole polarization energy and
!     derivatives with respect to Cartesian coordinates using
!     a subset of atoms in gaz phase
!
!
!> @brief 
...
!
!     rotates all the multipoles of the group
!
   do i = 1, npolegroup
...
!     #################################################################
!     ##                                                             ##
!     ##  subroutine epreal1_group  --  group polarization derivs    ##
!     ##                                                             ##
!     #################################################################
!
!
!     "epreal1_group" evaluates the
!     polarization energy and gradient due to dipole polarization
!     of a subset of atoms
!
!
!> @brief 
!> "epreal1_group" evaluates the
