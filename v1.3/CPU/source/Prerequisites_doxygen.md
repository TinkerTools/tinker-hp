# Prerequisites for the GPU version {#prerequisites}
...
@note PGI compiler does not support the GPU code on macOS.

   - [Nvidia HPC Package](https://developer.nvidia.com/nvidia-hpc-sdk-releases) Any version under **22.7 !** is operational.  
...
In the case where you do not have write access in the directory, you can also edit a local file and *export* an env variable named `NVLOCALRC` to hold the file path.
