...
!
!> @brief 
!> assigns charge magnitude and damping parameters for
!> charge transfer interactions and processes any new or changed
!> values for these parameters
!> @param no params
subroutine kchgtrn
...
!
!     subroutine kchgtrn_update: update local chgtrn
!
!> @brief 
!  update local chgtrn parameters
!> @param no params
subroutine kchgtrn_update(istep)
   use atmlst
   use atoms
   use atmtyp
   use chgpen
...
!
!> @brief 
!> deallocate shared memory pointers for charge transfer
!> parameter arrays
!> @param no params
...
!
!> @brief 
!> allocate shared memory pointers for charge transfer
!> parameter arrays
!> @param no params
