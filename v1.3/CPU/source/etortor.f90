...
!> site and inverts the angle values if the site is chiral
!> @param[in] ib: first atom involved in the angle
!> @param[in] ic: second atom involved in the angle
!> @param[in] id: third atom involved in the angle
!> @param[in] value1: value of the first angle
!> @param[in] value2: value of the second angle
