...
contains
   ...
   subroutine update_normal_modes_pi(polymer)
      ...
      implicit none
      type(POLYMER_COMM_TYPE), intent(inout) :: polymer
      integer :: i,k,ibead,iloc,ilocbeg,ilocend,nu
      real*8 :: sqrtnuinv
   ...
   subroutine contract_polymer(polymer,polymer_ctr)
      ...
      integer :: i,k,ibead,iloc,ilocbeg,ilocend
      integer :: nu,nuctr
   ...
   subroutine project_forces_ctr(polymer,polymer_ctr,slow)
      ...
      integer :: i,k,ibead,iloc,ilocbeg,ilocend,nu,nuctr
      real*8 :: nuratio
      logical :: slow_
   ...
   subroutine kinetic_pi_fast(polymer)
      ...
      integer :: i,j,k,l,iloc,ilocbeg,nu
