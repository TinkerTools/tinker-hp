...
!
!> @brief 
!> assigns the force constants and ideal distances
!> for the Urey-Bradley 1-3 interactions; also processes any
!> new or changed parameter values
!> @param no params
subroutine kurey
...
!
!     process keywords containing Angle repulsion parameters
!
   header = .true.
   do i = 1, nkey
      next = 1
...
!
!     process keywords containing Quartic Urey parameters
!
   header = .true.
   do i = 1, nkey
      next = 1
...
!
!     subroutine kurey_update: update local urey bradley
!
!> @brief 
