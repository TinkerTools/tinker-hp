...
!
!> @brief 
!> tests an atom or a set of connected atoms for
!> their presence within a single 3- to 6-membered ring
!> @param[in] iring: index of ring
!> @param[in] ia: index of first atom
!> @param[in] ib: index of second atom
!> @param[in] ic: index of third atom
!> @param[in] id: index of fourth atom
