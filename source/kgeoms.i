...
c
      ...
      common /kgeoms/ xpfix,ypfix,zpfix,
     &                pfix,dfix,afix,
     &                tfix,gfix,chir,
     &                depth,width,rwall,npfix,ipfix,
     &                kpfix,ndfix,idfix,nafix,
     &                iafix,ntfix,itfix,ngfix,
     &                igfix,nchir,ichir,use_basin,
     &                use_wall,
     $                npfixloc,ndfixloc,nafixloc,ntfixloc,ngfixloc,
     $                nchirloc
