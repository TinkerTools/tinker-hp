...
c
      if (associated(iratx)) deallocate (iratx)
      if (associated(kratx)) deallocate (kratx)
      if (associated(irat)) deallocate (irat)
      if (associated(krat)) deallocate (krat)
      if (associated(ratimage)) deallocate (ratimage)
c
c     iratx
c
      arrayshape=(/n/)
