...
c
      if (use_vdw) then
         ...
         timevec1 = mpi_wtime()
         if (rank.eq.0.and.tinkertime.and.timevec1-timevec0.gt.1e-6)
     &      write(*,*) 'time elj3 = ',timevec1-timevec0
         timevec0 = mpi_wtime()
         if (vdwtyp .eq. 'BUFFERED-14-7')  call ehal3
         timevec1 = mpi_wtime()
         if (rank.eq.0.and.tinkertime.and.timevec1-timevec0.gt.1e-6)
     &      write(*,*) 'time ehal3 = ',timevec1-timevec0
      end if
c
...
c
      ...
      if (use_charge) call echarge3
         timevec1 = mpi_wtime()
         if (rank.eq.0.and.tinkertime.and.timevec1-timevec0.gt.1e-6)
     &      write(*,*) 'time echarge3 = ',timevec1-timevec0
         timevec0 = mpi_wtime()
      if (use_mpole)  call empole3
         timevec1 = mpi_wtime()
         if (rank.eq.0.and.tinkertime.and.timevec1-timevec0.gt.1e-6)
     &      write(*,*) 'time empole3 = ',timevec1-timevec0
         timevec0 = mpi_wtime()
      if (use_polar)  call epolar3
         timevec1 = mpi_wtime()
         if (rank.eq.0.and.tinkertime.and.timevec1-timevec0.gt.1e-6)
     &      write(*,*) 'time epolar3 = ',timevec1-timevec0
