...
c
     ...
     $     npoleloc,MPI_REAL8,p_send1(i),tag,COMM_BEAD,
     $     reqsend(i),ierr)
        end do
c
c
...
c
     ...
     $   MPI_REAL8,prec_recep(i),tag,COMM_BEAD,reqrec(i),ierr)
      end do
c
c     MPI : begin sending
c
     ...
     $   2*n1mpimax*n2mpimax*n3mpimax,MPI_REAL8,proc,tag,COMM_BEAD,
     $   reqsend(i),ierr)
      end do
c
      do i = 1, nrec_recep
...
c
     ...
     $   prec_send(i),tag,COMM_BEAD,reqbcastrec(i),ierr)
      end do
c
c     MPI : begin sending
c
     ...
     $   MPI_REAL8,prec_recep(i),tag,COMM_BEAD,reqbcastsend(i),
     $   ierr)
      end do
c
      do i = 1, nrec_send
