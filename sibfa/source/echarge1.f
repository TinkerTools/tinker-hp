...
c
        ...
        decrec(1,iloc) =fi*(recip(1,1)*de1+recip(1,2)*de2
     &                                     +recip(1,3)*de3)
        decrec(2,iloc) =fi*(recip(2,1)*de1+recip(2,2)*de2
     &                                     +recip(2,3)*de3)
        decrec(3,iloc) =fi*(recip(3,1)*de1+recip(3,2)*de2
     &                                     +recip(3,3)*de3)
      end do
      time1 = mpi_wtime()
