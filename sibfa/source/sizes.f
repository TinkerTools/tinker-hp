...
c     maxatlst        neighbors in dispersion atom-atom pair list
c     maxbondlst     neighbors in repulsion bond-bond pair list
c     maxlplst        neighbors in lp-lp pair list
...
c
      ...
      integer maxatlst,maxbondlst,maxlplst
      integer maxfft
      ...
      parameter (maxbondlst=4500)
      parameter (maxlplst=4800)
      parameter (maxatlst=4800)
