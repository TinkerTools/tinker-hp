...
c
c     acceptlist list of the acceptors numbers involving each atom
c     
...
c
c     lpglob local-global lone pair correspondance
c     acceptglob local-global lone pair correspondance
c
...
c     lpglobbnl  localnl - global lone pair correspondance 
c     acceptglobbnl  localnl - global acceptor correspondance 
c     bondglobbnl  localnl - global bond correspondance 
c
      module atmlst
      implicit none
      integer, pointer :: bndlist(:,:),anglist(:,:)
      integer, allocatable :: acceptlist(:)
      ...
      integer, allocatable :: lpglob(:),acceptglob(:)
      integer, allocatable :: chgglobnl(:),vdwglobnl(:),poleglobnl(:)
      integer, allocatable :: lpglobnl(:),acceptglobnl(:)
      integer, allocatable :: bondglobnl(:)
      save
      end
