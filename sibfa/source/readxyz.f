...
c      open(1344, file="distance.dat")
c      do i=1,n,4
c        write(1344,'(2e20.5)') sqrt((x(i+1)-x(i))**2+(y(i+1)-y(i))**2
c     &          +(z(i+1)-z(i))**2)
c        write(1344,'(2e20.5)') sqrt((x(i+2)-x(i))**2+(y(i+2)-y(i))**2
c     &          +(z(i+2)-z(i))**2)
c      enddo
c
c      open(1354, file="angle.dat")
c      do i=1,n,4
c        a=sqrt((x(i+1)-x(i))**2+(y(i+1)-y(i))**2
c     &          +(z(i+1)-z(i))**2)
c        b=sqrt((x(i+2)-x(i))**2+(y(i+2)-y(i))**2
c     &          +(z(i+2)-z(i))**2)
c        c=sqrt((x(i+2)-x(i+1))**2+(y(i+2)-y(i+1))**2
c     &          +(z(i+2)-z(i+1))**2)
c        
c        write(1354,'(2e20.5)') acosd((a**2+b**2-c**2)/(2*a*b))
c      enddo
c
