...
c     #####################################################################
c     ##                                                                 ##
c     ##  subroutine dispersion3  --  dispersion energy & analysis        ##
c     ##                                                                 ##
c     #####################################################################
c
c
...
c
c     "dispersion3b" calculates the dispersion energy
c     
      subroutine edispersion3b
      use action
      use analyz
      use atmtyp
      use atmlst
