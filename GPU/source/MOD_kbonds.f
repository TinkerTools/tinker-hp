...
#include "tinker_precision.h"
      ...
      real(t_p) bcon(maxnb),blen(maxnb)
      real(t_p) bcon5(maxnb5),blen5(maxnb5)
      real(t_p) bcon4(maxnb4),blen4(maxnb4)
      real(t_p) bcon3(maxnb3),blen3(maxnb3)
      real(t_p) dlen(maxnel)
