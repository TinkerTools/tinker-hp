...
c
   ...
   10 format (/,5x,70('#'),
     ...
     &           ' Molecular Design',9x,'###',
     &        /,1x,'##',74x,'##',
     &        /,1x,'##',24x,'Version 1.2(GPU) Octobre 2020',21x,'##',
     &        /,1x,'##',74x,'##',
     ...
     &       '   Louis Lagardeère, Luc-Henri Jolly, Filippo Lipparini,',
     &       ' Felix Aviat,',/,
     &       '   Benjamin Stamm, Zhifeng F. Jing, Matthew ',
     &       'Harger, Hedieh Torabifard,'/,
     &       '   G. Andreès Cisneros, Michael J. Schnieders, Nohad ',
     &       'Gresh, Yvon Maday,',/,
